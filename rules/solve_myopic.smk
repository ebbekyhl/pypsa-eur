...
rule add_existing_baseyear:
    ...
    output:
        uk_brownfield_power_plant_under_construction = resources("uk_brownfield_cleaned_powerplants_{clusters}_{opts}_{sector_opts}_{planning_horizons}_under_construction.csv"),
